...
var sequenceInfo = exports.sequenceInfo = {
  intro: {
    ...
    about: {
      ...
      'hu'   : 'Egy bevezetés a fontosabb Git parancsok működésébe',
    }
  },
  rampup: {
    displayName: {
    ...
    about: {
      ...
      'hu'   : 'A következő kihagyhatatlan Git ajánlat! Reméljük éhes vagy!'
    }
  },
  remote: {
    tab: 'remote',
    displayName: {
      ...
      'hu'   : 'Push & Pull -- Avagy Git Remote-ok!'
    },
    about: {
      ...
      'hu'   : 'Itt az ideje, hogy kigyere a pincéből! A kódolás egy társas tevékenység!'
    }
  },
  remoteAdvanced: {
    tab: 'remote',
    displayName: {
      ...
      'hu'   : 'Origin és a Többiek -- Haladó Git Remote használat'
    },
    about: {
      ...
      'hu'   : 'És még azt gondoltad, hogy egy jótékony diktátor munkája könnyű...'
    }
  },
  move: {
    displayName: {
  ...
  mixed: {
    ...
    about: {
      ...
      'hu'   : 'Különböző hasznos Git technikák, tippek, trükkök',
    }
  },
  advanced: {
    displayName: {
